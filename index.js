...
// 3c çözümü:
let ucetambolunenler = sayilar.filter(sayi => sayi % 3 === 0);
...
let tekraredensayilar2 = [];
for (let sayi in tekraredensayilar) {
  if (tekraredensayilar[sayi] > 1) {
  tekraredensayilar2.push(`${sayi} sayısı ${tekraredensayilar[sayi]} kere tekrar edilmiştir`);
  }
};
/* kodlar buraya */
console.log(tekraredensayilar2);
